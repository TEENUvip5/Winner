...
TELEGRAM_BOT_TOKEN = '7937794618:AAGda51S0bCrZZQCPoimjBTv30fHoqcJlFM'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🎉 Welcome to the IGL Ultimate UDP Flooder! 🎉*\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user["coins"] < COINS_REQUIRED_PER_ATTACK:
        await context.bot.send_message(
            chat_id=chat_id,
            text="*💰 Insufficient coins! Please contact the admin to acquire more coins. DM: @ILLEGALCHEAT78*",
            parse_mode='Markdown'
        )
        return
    ...
    if len(args) != 3:
        await context.bot.send_message(
            ...
            text=(
                ...
                "*📌 Example: /attack 192.168.1.1 26547 300*"
            ),
            parse_mode='Markdown'
        )
        return
...
async def help(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "- *If you encounter any issues, contact the admin: @ILLEGALCHEAT78*\n\n"
